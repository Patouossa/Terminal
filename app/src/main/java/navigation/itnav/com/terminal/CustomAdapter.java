...
public class CustomAdapter extends ArrayAdapter<SettingItem> {
    SettingItem[] list_values;
    Context ctx;
    public CustomAdapter(Context context, int resource, int textViewResourceId, SettingItem[] objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            RadioButton r = (RadioButton)v.findViewById(R.id.settingRadioButton);
        }
        TextView tv = (TextView)v.findViewById(R.id.txtSettingsItem);
